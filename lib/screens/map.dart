...
class MapScreenState extends State<MapScreen> {
  ...
  Future<void> drawMarkers(MapboxMapController controller) async {
    ...
    Color? textColor = Themes.theme().textTheme.bodySmall?.color;
    Color? textBorderColor = Themes.theme().textTheme.bodySmall?.color;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(Icons.gps_fixed, color: Themes.theme().textTheme.bodySmall?.color),
      ),
    );
  }
}
