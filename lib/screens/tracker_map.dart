...
class TrackerPositionMapScreenState extends State<TrackerPositionMapScreen> {
  ...
  Future<void> drawMarkers(
      MapboxMapController controller, List<TrackerPosition> positions) async {
  ...
  Future<void> drawTrajetory(
    ...
    await controller.addLine(LineOptions(
        geometry: points, lineWidth: 1.0, lineOpacity: 1.0, draggable: false));
  }
  ...
  Future<void> addImage(
      MapboxMapController controller, String name, String path,
      {bool sdf = true}) async {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: Icon(Icons.list,
              color: Themes.theme().textTheme.bodySmall?.color),
        ),
